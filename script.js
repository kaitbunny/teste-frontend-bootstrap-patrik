$(document).ready(function(){
  ...
  //aplica mascara nos campos de texto do formulario
  function applyMask() {
  ...
  //metodos personalizados para validar data e celular
  ...
  function validationFormConfig() {
    $(".main-form").validate({
      ...
      messages: {
        ...
        telefone: "Por favor, digite um número de telefone válido com 10 dígitos!",
  ...
  function openUpdatePopup(contatoId) {
    Swal.fire({
      ...
      <form id="form-atualizar" class="main-form row">
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-nome">Nome completo</label>
          <input class="form-control text-start" type="text" id="edit-nome" name="nome" placeholder="Ex.: Patrik Pereira dos Santos" required>
        </div>
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-data">Data de nascimento</label>
          <input class="form-control text-start data" type="text" id="edit-data" name="data" placeholder="Ex.: 12/05/2003" required>
        </div>
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-email">E-mail</label>
          <input class="form-control text-start" type="email" id="edit-email" name="email" placeholder="Ex.: patrik@gmail.com" required>
        </div>
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-profissao">Profissão</label>
          <input class="form-control text-start" type="text" id="edit-profissao" name="profissao" placeholder="Ex.: Desenvolvedor Backend" required>
        </div>
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-telefone">Telefone para contato</label>
          <input class="form-control text-start telefone" type="text" id="edit-telefone" name="telefone" placeholder="Ex.: (11) 4002-8922">
        </div>
        <div class="form-text-input col-md-6 col-sm-12 text-start mb-4">
          <label class="form-label" for="edit-celular">Celular para contato</label>
          <input class="form-control text-start celular" type="text" id="edit-celular" name="celular" placeholder="Ex.: (11) 98493-2039" required>
        </div>
        <div class="form-checkbox-input col-md-6 col-sm-12 mb-4">
        ...
        <div class="form-checkbox-input mb-4">
